...
export default class Pev03 extends React.Component {
    ...
    render() {
        return (
            <ScrollView style={styles.container}>
                <Text>Esta é a tela Pev03! Aperte o botão salvar acima para uma mensagem interessante!</Text>
            </ScrollView>
        );
    }
}
